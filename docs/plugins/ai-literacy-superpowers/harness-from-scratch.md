...
- [How-to: Set Up Secret Detection]({% link plugins/ai-literacy-superpowers/set-up-secret-detection.md %}) —
...
- [Reference: HARNESS.md Format]({% link plugins/ai-literacy-superpowers/harness-md-format.md %}) — full
