...
[Sync Conventions]({% link docs/plugins/ai-literacy-superpowers/sync-conventions.md %})
(convention and constraint files) and
[Generate an Onboarding Guide]({% link docs/plugins/ai-literacy-superpowers/generate-onboarding.md %})
(`ONBOARDING.md`).
...
- [The Harness Tuning Loop]({% link docs/plugins/ai-literacy-superpowers/the-harness-tuning-loop.md %})
  — the Propagate stage (Stage 5) that `/harness-sync` serves
- [The Harness Lifecycle]({% link docs/plugins/ai-literacy-superpowers/the-harness-lifecycle.md %})
