...
4. **Dispatch** the [`model-card-researcher`](agents.md)
...
See the [research a model card](../how-to/research-a-model-card.md)
...
See the [seed your library](../how-to/seed-your-library.md)
