...
This page introduces the concepts of constraint maturity and enforcement timing. For detailed mechanics, see [Progressive Hardening]({% link explanation/progressive-hardening.md %}) and [The Three Enforcement Loops]({% link explanation/three-enforcement-loops.md %}).
...
- [Progressive Hardening]({% link explanation/progressive-hardening.md %}) — detailed promotion ladder mechanics
- [The Three Enforcement Loops]({% link explanation/three-enforcement-loops.md %}) — inner, middle, and outer loop details
- [Context Engineering]({% link explanation/context-engineering.md %}) — what context declares before constraints enforce
- [Codebase Entropy]({% link explanation/codebase-entropy.md %}) — fighting the drift that constraints miss
