...
For the document itself — what `HARNESS.md` is, how it is operated, and how it compares to `AGENTS.md` / CI / hooks — see [HARNESS.md, the Document]({% link explanation/harness-md.md %}).
