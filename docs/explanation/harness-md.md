...
- [Harness Engineering]({% link explanation/harness-engineering.md %}) —
...
- [The Self-Improving Harness]({% link explanation/self-improving-harness.md %}) —
...
- [Agent Orchestration]({% link explanation/agent-orchestration.md %}) —
  how `AGENTS.md` and `HARNESS.md` interact in the spec-first pipeline
- [HARNESS.md format reference]({% link reference/harness-md-format.md %}) —
  the field-by-field reference for the document itself
- [How to: Add a Constraint]({% link how-to/add-a-constraint.md %}) —
