...
[![ai-literacy-superpowers](https://img.shields.io/badge/ai--literacy--superpowers-v0.36.0-4682B4?style=flat-square)](ai-literacy-superpowers/)
...
[![Harness](https://img.shields.io/badge/Harness-21%2F22_enforced-4682B4?style=flat-square)](HARNESS.md)
...
| ------ | ------- | ------------ | ---- |
| **`ai-literacy-superpowers`** | v0.36.0 | The flagship. Harness engineering, agent orchestration, literate programming, CUPID code review, compound learning, and the three enforcement loops. **30 skills, 13 agents, 25 commands.** | [docs](docs/plugins/ai-literacy-superpowers/index.md) |
